# Form implementation generated from reading ui file 'ThemSanPham.ui'
#
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.btnThemSanPham.setGeometry(QtCore.QRect(230, 370, 191, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
...
#===============================================================================
        ...
        self.btnThemSanPham.setIcon(QIcon("../Access/Icon/update.png"))
        self.btnThemSanPham.setIconSize(QSize(30,30))
        #CSS Button
...
#==================================Hàm===========================================
    ...
    def themSanPham(self):
        ...
        if idSanPham == '' or soLuong == '' or tenSanPham == '' or donGia == '' or idNhaCungCap == '':
            ...
            sanPham.addSanPham(idSanPham, soLuong, tenSanPham, donGia, idNhaCungCap)
            QMessageBox.information(self.Dialog, "Thông báo", "Thêm Sản Phẩm thành công")
            self.quayve()
...
#===============================================================================
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Thêm Sản Phẩm"))
