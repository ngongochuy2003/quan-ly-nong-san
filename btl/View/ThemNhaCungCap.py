...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.btnThemNhaCungCap.setGeometry(QtCore.QRect(230, 370, 191, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.btnThemNhaCungCap.setIcon(QIcon("../Access/Icon/update.png"))
        self.btnThemNhaCungCap.setIconSize(QSize(30,30))
        #CSS Button
        ...
        self.btnThemNhaCungCap.clicked.connect(self.themNhaCungCap)
    #===============================================================================
    def quayve(self):
    ...
    def themNhaCungCap(self):
        ...
        ncc = NhaCungCapController()
        ncc.addNhaCungCap(idnhacungcap, tennhacungcap, diachi, sodienthoai, email)
        QMessageBox.information(self.Dialog, "Thông báo", "Thêm Nhà cung cấp thành công")
        self.quayve()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Thêm Nhà Cung Cấp"))
